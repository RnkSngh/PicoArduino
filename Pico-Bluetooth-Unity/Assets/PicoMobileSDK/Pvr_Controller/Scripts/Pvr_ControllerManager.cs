...
public class Pvr_ControllerManager : MonoBehaviour
{
    ...
    {
        //connect bluetooth
      //  device = BluetoothAdapter.getPairedDevices()[0];
        //Debug.Log("6-30-20" + device.Name);
     //   device.setEndByte(10);
      //  device.normal_connect(true, false);
   //     Debug.Log("6-31-20" + device.IsConnected.ToString());
    ...
    void Update()
    {
        //try
        //{ 
    //        Debug.Log("6-5-20" + device.IsConnected.ToString());
  //          string message;
//                byte[] msg = device.read();//because we called setEndByte(10)..read will always return a packet excluding the last byte 10.
               ...
               // {
                   ...
                   // message = "MSG : " + content;
                 //   device.send(new byte[] { 51, 10 });
               // Debug.Log("6-7-30" + device.IsConnected.ToString());
                   // Debug.Log("6-7-21" + message);
               // }
            
      //  }
       // catch (Exception e)
        //{
          //  Debug.Log("6-50-20" + e.Message);
        //}
